...
function formatCompoundCondition(
  ...
  for (const cond of conditions) {
    ...
    if (cond.choiceCondition) {
      const choiceLabels = resolver.getChoiceLabels(cond.nodeId, cond.choiceCondition.choiceIds);
 ...
 */
export function createConditionLabelResolver(nodes: FlowchartNode[]): ConditionLabelResolver {
